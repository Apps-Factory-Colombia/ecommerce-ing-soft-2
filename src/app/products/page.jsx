        ...
        <main className="bg-white font-sans text-gray-800">
                    ...
                    {productos.map((producto) => {
                        ...
                        return (
                            <div key={producto.id} className="w-60 text-center">
                                ...
                                <p className="text-sm text-green-600 font-bold">${precioConDescuento.toFixed(2)}</p>
                            </div>
                        );
                    })}
                </div>
            ...
            <section className="flex flex-col items-center py-20 px-4 bg-white">
                ...
                <p className="text-center max-w-2xl text-gray-600">
                    Originado en América, nuestro producto ha sido nominado como Marca del Año.
                    Con tu apoyo, ganamos esta nominación. Costy comenzó con una idea: hacer moda
                    que los jóvenes quieran usar explorando colores audaces que reflejen la verdadera individualidad.
                </p>
            </section>

            {/* Llamado a la Acción */}
            <section className="text-center py-20 bg-gray-100">
                <h2 className="text-5xl font-extrabold text-gray-200 uppercase mb-6">Los colores son estilo</h2>
            ...
            <section className="flex flex-col items-center bg-white py-16">
                <h2 className="text-3xl font-bold mb-4">¡Únete a la tendencia, encuentra más estilo!</h2>
                <input
                    type="email"
            ...
            <footer className="bg-blue-900 text-white text-center py-10">
                <h3 className="text-2xl font-bold mb-2">Alfonso</h3>
                <div className="flex justify-center space-x-4 mt-4">
                    <a href="#"><i className="fab fa-facebook-f" /></a>
                    <a href="#"><i className="fab fa-instagram" /></a>
                    <a href="#"><i className="fab fa-youtube" /></a>
                </div>
                <p className="mt-6 text-sm">© 2025 Alfonso. Todos los derechos reservados. Alfonso Murillo</p>
            </footer>
        </main>
    );
}
